...
export default function Landing() {
  return (
    <section className="min-h-screen relative overflow-hidden bg-[#f2e8cf]">
      <div className="absolute right-[14rem] top-[20rem] -translate-y-1/2 z-20">
        <h2 className="developer-text text-[110px] font-['Londrina_Shadow'] text-gray-800 font-semibold">DEVELOPER</h2>
      </div>
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center min-h-screen p-2 md:p-[5rem]">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-['Londrina_Shadow'] text-gray-800">KHUSHI PAWAR</h1>
          ...
          >
            <a href="#" className="text-gray-800 hover:text-[#bc4749] transition-colors">
